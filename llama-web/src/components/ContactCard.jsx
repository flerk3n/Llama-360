  ...
  return (
    <section id="contact" className="py-12">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <h2 className="mb-6 text-center text-3xl font-poppins font-bold text-white">Contact Us</h2>
        
        <div className="mx-auto max-w-3xl">
          <div className="glass glass-hover overflow-hidden rounded-2xl p-6 md:p-8">
            <div className="grid gap-6 md:grid-cols-3">
              ...
              <div className="flex flex-col items-center">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-blue-500/20">
                  <svg className="h-6 w-6 text-blue-400" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
